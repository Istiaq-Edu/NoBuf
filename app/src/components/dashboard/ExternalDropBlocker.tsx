...
export function ExternalDropBlocker({ onUploadClick }: { onUploadClick: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center pointer-events-none">
            <div className="glass bg-nobuf-surface border border-nobuf-border rounded-2xl p-8 max-w-md mx-4 shadow-2xl pointer-events-auto">
                <div className="flex flex-col items-center text-center gap-4">
                    <div className="w-16 h-16 rounded-full bg-nobuf-primary/20 flex items-center justify-center">
                        <Upload className="w-8 h-8 text-nobuf-primary" />
                    </div>
                    <div>
                        <h3 className="text-lg font-semibold text-nobuf-text mb-2">
                    ...
                    <button
                        ...
                        className="mt-2 px-6 py-2 bg-nobuf-primary text-white rounded-lg font-medium hover:bg-nobuf-primary/90 transition-colors"
                    >
                        Open Upload Dialog
                    </button>
                </div>
