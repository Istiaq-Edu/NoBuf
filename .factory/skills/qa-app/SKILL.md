...
name: qa-app
description: >
  QA tests for the Telegram Drive desktop app. Covers REST API endpoints (CI-compatible
...
**Success criteria:** Dashboard shows files/folders from Saved Messages. Sidebar shows folder list. Top bar shows "Telegram Drive" with connection status.
